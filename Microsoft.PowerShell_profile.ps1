...
#path Directory
$env:PATH += ";C:\Users\Digital_Russkiy\AppData\Local\Microsoft\PowerToys\PowerToys Run\ptr.exe"
...
Set-Alias -Name checkpath -Value Show-Path
...
# Create function to display PATH environment variable

...
function Restart-AzMigrateServerReplication {
    ...
    process {
        ...
        if ($ReplicationMigrationItem -and ($ReplicationMigrationItem.ProviderSpecificDetail.InstanceType -eq 'VMwarecbt')) {
            $ProviderSepcificDetail = [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.VMwareCbtResyncInput]::new()
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC20ANy6LHyk/HQ
# cVbacwKRSD1vQfpFRPbjvXZ0IwDgEKCCDXYwggX0MIID3KADAgECAhMzAAAEBGx0
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIOjYs2PkE61+MqqsKQIpZqk3
# No7PSBicnR+24GJlgr36MEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
# BQAEggEAinAhN1cpOfLVRDQuaPhblD4lg21+5uJJQ+w7Nv8Y8jd0daCcz+I3w+vc
# EGG5SW6WFIiyI1wyhlsrRh4GgMJV/yQueASzG9gVxrtVMSUexSef5E1yld0igkL9
# HAjzWxqceVIdza3F5mPc5hJ8WA0/nx7sS295C0QFBq/oXkwaogW0p1ojigYHulRj
# 1fpPQfFy4ewd4JvcxoOLO4vFoWPjk2zaNBKLuzgVQPWgmZRNtLTWwzEmsTvt1q/d
# /qG/MUoeoHK36uC48kx2owcJ9V6/O0CyQpGSzOrj0Lj2yd0q+br82GHUQn/qMGsX
# Xc4T0LgxQRBmDbdJYpFirSV9Wun6NqGCF5QwgheQBgorBgEEAYI3AwMBMYIXgDCC
# F3wGCSqGSIb3DQEHAqCCF20wghdpAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFSBgsq
# hkiG9w0BCRABBKCCAUEEggE9MIIBOQIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFl
# AwQCAQUABCAwGYZDvIDsZ56vn4f/mU0lMR0EAHLNAQS/GL36H2rZLwIGaBKyv3pQ
# GBMyMDI1MDUxNDA5MTkxMi45NzJaMASAAgH0oIHRpIHOMIHLMQswCQYDVQQGEwJV
...
# CSqGSIb3DQEJBDEiBCDbc5MYB6BPgWGYtAY4hnEKj20ynsUEfessRgX7r2LVCTCB
...
# 8bULDHTtCdlxLVswDQYJKoZIhvcNAQELBQAEggIAm4KMu6wwkxw/gYym6rZ9eL2c
# +aDrPDIozFYmevl0klSUTz/IUbosN7YtwJ/SFGUI6iAVZuErv1MCy+kRuEWSlvji
# uZq1T7W/L9X/2lzWjDNnz3TNnE+go3uiQWhcRBvPV7QSC4ZFi7XkX6/4I34sgL1R
# nuqQpJwWOGWJI7eAuDk/oqhNID9W7Lex7ado2Df+JPgr9eAaU/O7wlkY0AXfQOy5
# cecFtAVG8uUsmWVaOxlu7XwjYVQk2prMWzPEJBr9MlRm7rJf74GL+XJF9Xy5As52
# rX5vcXidoqB0YRCSAp9dWeSQU5UB7jCZ53NCc8TZhWBfxmDu6DhNB/BYfidWTuBX
# 4HV5l6YgIBeVjWCb9CxIH73htRjuDtEfCaVHAFu/bCV/s/JlfC9rAb/8yprMQ4K4
# i+kdRDKwdXq5F0Y288FNoPNmgIEkRdq+0iG3pT7teBPfx7kdo92X3eSAzibnEiRc
# ClGkPdi3JFx8fbFrnXWx9aQMfy148/nldR06ZEWVl7j5/b8TRXejagPffIQ2TaqI
# ULRSOx3Odm5pPFq8BLKH4Zi7LpNMQR7PEn4Uvq06KXhRgnkdIh0KiZxcBCNYc9k5
# AMFiVvI85hFw19NtActsYyHan7KZZnTlyqfls64v6ml4MpXVRPTHtVZbiySh80LT
# H4bNMbzq4jfn43xRJCU=

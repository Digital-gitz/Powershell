...
function Resume-AzMigrateServerReplication {
    ...
    process {
        ...
        if ($ReplicationMigrationItem -and ($ReplicationMigrationItem.ProviderSpecificDetail.InstanceType -eq 'VMwarecbt') -and ($ReplicationMigrationItem.AllowedOperation -contains 'ResumeReplication')) {
            ...
            $ProviderSpecificDetailInput = [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202401.VMwareCbtResumeReplicationInput]::new()
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB9O1qh+WPzY7wG
# tHBx7muzdN/dnWj9tT9IkY6k5CjyeqCCDXYwggX0MIID3KADAgECAhMzAAAEBGx0
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIINKjIAqEdputFnqpuX40fql
# 4PziGxflRXIZWf/N0qB6MEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
# BQAEggEAk9F50oviIsdNiSazwaV7GgY77XSRyZhCF5fzyCqn/Un+aRRLatPkFXcm
# lkXPCUFA5MmK+O3wUoI9giBjBzfMKflAnNAoi40IS6BdEurH9I4caCcHnVuosb3T
# 7TxLiqvXZsEEPQxw85njE8nMYONSZsL30+2Xdq/MY5+j4Yww1z4NENmdCAsuhn+W
# Ml8pPpZQN08GknR3dHfKkq/2T43KtCMqXvSMSs+OQ4KIBiqQhNtPWqJgDsUznsi2
# ycKSTezpYsRoYT4Q0+3dL5uzBC158Jjjswdx3NSXo1o838G5NN3BYyCoFmq/onbz
# 0K6aml+k/FxhNGCzd6dr23xvr5ylOqGCF7AwghesBgorBgEEAYI3AwMBMYIXnDCC
# F5gGCSqGSIb3DQEHAqCCF4kwgheFAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFaBgsq
# hkiG9w0BCRABBKCCAUkEggFFMIIBQQIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFl
# AwQCAQUABCCK+8ttBMQuqqpTpuaXyUqgRaHPRM3iMxDRqV8qiTtM3wIGaC4+OfgB
# GBMyMDI1MDUyODA3MzE0Ny4yODRaMASAAgH0oIHZpIHWMIHTMQswCQYDVQQGEwJV
...
# CSqGSIb3DQEJAzENBgsqhkiG9w0BCRABBDAvBgkqhkiG9w0BCQQxIgQg7+pEBqs2
# Nd41uTL1mYC3iadAVNThcWfcE+IvXJYd19kwgfoGCyqGSIb3DQEJEAIvMYHqMIHn
...
# DQEBCwUABIICAAuaX1FC0ZWaoepnEeEzhJCdCJosn22GSergTB7jTpo+Z/PKbfdo
# TYOnocqtBF6JhaNYNsCWa8dpT2fEidZtBqFHD8v3luh40wd8dt3HzOOxlPtACYho
# DiFd9PIQk4IhgH11aQM0wyBGoVjpGROuuIXXmPONdumXRWP/sI7jOTuJX95tqds/
# 8QdDGbFKZUk2a6Si59BGvF5nepElNLMDml2kVDWKn3A0EOBPCMELANlSzcvRMu4S
# G8ozGtzj1vsP06qhK8wECzg+TOsZpcrUPWmF/kjY5rHe7PWb0FqgAMm3YbXrotqM
# qxQ6WcAHLx0W47bywmUPuZ1eCnzjJjbEwx1xPmm53Q4prcPW2gQBPS3p3P/vMwg2
# Yam9GqqzyzmphVqXixO0AKxsstAMMq2c45Nf/eoWH2sGqfaMDQ9lzaCl8zfH9Oaa
# ZuKfQvOtXotYqSEIsohNYIgKrZxcFV+j0u2u7unKRp1X1nRPmBvrBzms6xNU+/bh
# uA8Jm/QlPOfllSPbq6sK0p1+aQ7SiVqoxnc27vmFHmu1Adc8ujwhx7nRivQLx94i
# SqxO3u9zSHgShRppMN4TPXGM/Itg46xw6cbF+SJHC7oQowX4kkeH43ZDgit3eS+5
# 69eiZoaJY/Y35wX62/erdygke92DE9aiE2rstCFmPZ/wxkmx47Y+JviD

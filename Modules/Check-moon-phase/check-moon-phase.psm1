...
# Write a simple confirmation that the module was loaded
Write-Host "Moon phase module loaded. Use Get-MoonPhase to check the current moon phase." -ForegroundColor Green

# Export the function
Export-ModuleMember -Function Get-MoonPhase

...
@{
    ...
    FunctionsToExport = @('Connect-SteamAPI','Disconnect-SteamAPI','Get-SteamApp','Get-SteamFriendList','Get-SteamNews','Get-SteamPlayerBan','Get-SteamPlayerSummary','Resolve-VanityURL','Get-SteamServerInfo','Install-SteamCMD','Update-SteamApp','Update-SteamServer')

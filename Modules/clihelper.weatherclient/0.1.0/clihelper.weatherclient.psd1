#
# Module manifest for module 'clihelper.weatherclient'
#
...
@{
  ...
  RootModule            = 'clihelper.weatherclient.psm1'
  ...
  GUID                  = 'b3e233a5-6711-4cfa-a7a6-4459aef071de'
  ...
  PrivateData           = @{
    ...
    PSData = @{
      ...
      ProjectUri   = 'https://github.com/alainQtec/clihelper.weatherclient'

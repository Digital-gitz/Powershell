...
try {
    ...
    if ($statusCode -eq 403) {
        Write-Host "ArtStation is blocking automated requests (403 Forbidden)." -ForegroundColor Yellow
        Write-Host "This is common with sites using bot protection. Opening in browser instead..." -ForegroundColor Yellow
    }
    elseif ($statusCode) {
